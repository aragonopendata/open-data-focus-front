...
export class Constants {
  public static SERVER_URL = 'https://desopendata.aragon.es';
  ...
  // URLS FOCUS
  public static FOCUS_URL = 'https://desopendata.aragon.es/servicios/datoteca';

  // URLS GLOBAL
  public static AOD_BASE_URL = 'https://desopendata.aragon.es';
  public static PRESUPUESTOS_BASE_URL = 'http://presupuesto.aragon.es';
  public static AOD_ASSETS_BASE_URL = 'https://desopendata.aragon.es/static';
  public static AOD_API_WEB_BASE_URL =
    'https://desopendata.aragon.es/aod/services/web';
  public static AOD_API_ADMIN_BASE_URL =
    'https://desopendata.aragon.es/aod/services/admin';
  public static AOD_API_SECURITY_BASE_URL =
    'https://desopendata.aragon.es/aod/services/security';
  ...
  public static ROUTER_LINK_SERVICES_FOCUS = '/servicios/datoteca';
  ...
  // https://desopendata.aragon.es/GA_OD_Core/preview?resource_id=161&filters={​​​​​​"nivel"%3A"1"}​​​​​​

  public static GA_OD_CORE_BASE_URL = 'https://desopendata.aragon.es';
